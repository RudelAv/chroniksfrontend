...
export default function CreatePostCommunityForm({ communityId }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await ApiCommunity.createPost(session?.user?.accessToken, communityId, formData);
